...
public interface ClientHelpersApi {
	...
	@Operation(summary = "metadata resources details using UID", description = "returns detailed information useful to contextualise the discovery phase", tags = {
			"Resources Service" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "ok.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Distribution.class))),
			@ApiResponse(responseCode = "201", description = "Created."),
			...
			@ApiResponse(responseCode = "403", description = "Forbidden"),
			@ApiResponse(responseCode = "404", description = "Not Found") })
	@RequestMapping(value = "/resources/details", produces = { "application/json" }, method = RequestMethod.GET)
	ResponseEntity<Distribution> resourcesDiscoveryWithUIDGetUsingGET(
			@Parameter(in = ParameterIn.QUERY, description = "The distribution UID", required = true, schema = @Schema()) @RequestParam("uid") String id,
			@Parameter(in = ParameterIn.QUERY, description = "extended payload", schema = @Schema()) @Valid @RequestParam(value = "extended", required = false) Boolean extended);
	...
	@Operation(summary = "metadata facilities details", description = "returns detailed information useful to contextualise the discovery phase", tags = {
			"Resources Service" })
	@ApiResponses(value = {
	...
	@Operation(summary = "facilities search operation", description = "Search endpoint", tags = { "Resources Service" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "ok.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SearchResponse.class))),
			@ApiResponse(responseCode = "201", description = "Created."),
			@ApiResponse(responseCode = "204", description = "No content."),
	...
	@Operation(summary = "metadata equipments details", description = "returns detailed information useful to contextualise the discovery phase", tags = {
			"Resources Service" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "ok.", content = @Content(mediaType = "application/json", schema = @Schema(oneOf = {
	...
	@Operation(summary = "linked entities", description = "returns distributions that permit all the parameters specified", tags = {
			"Resources Service" })
	@ApiResponses(value = {
